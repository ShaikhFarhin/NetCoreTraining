    ...
    public partial class CityInfoDBInitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "Description", "Description1", "Name" },
                values: new object[] { 1, "The one with that big park.", null, "New York City" });

            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "Description", "Description1", "Name" },
                values: new object[] { 2, "The one with the cathedral that was never really finished.", null, "Antwerp" });

            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "Description", "Description1", "Name" },
                values: new object[] { 3, "The one with that big tower.", null, "Paris" });
